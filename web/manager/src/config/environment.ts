...
export const env = {
  ...
  githubRepository: import.meta.env.VITE_GITHUB_REPOSITORY ?? 'ferforastieri/atacte',
  androidApkUrl: import.meta.env.VITE_ANDROID_APK_URL ?? 'https://github.com/ferforastieri/atacte/releases/latest/download/atacte-android.apk',
  isDev: dev,
