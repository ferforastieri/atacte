<template>
  <div class="min-h-screen bg-gray-50 text-gray-900 transition-colors duration-200 dark:bg-gray-900 dark:text-gray-100">
    ...
    <footer class="border-t border-gray-200 dark:border-gray-700"><div class="flex w-full flex-col gap-3 px-4 py-6 text-sm text-gray-500 dark:text-gray-400 sm:flex-row sm:items-center sm:justify-between sm:px-6 lg:px-10 xl:px-12"><div class="flex items-center gap-2"><PublicLogo :size="24" /><span>Atacte · seu cofre, suas regras.</span></div><nav class="flex items-center gap-4" aria-label="Links do rodapé"><a class="transition-colors hover:text-primary-600 dark:hover:text-primary-400" href="/docs/">Documentação</a><a class="transition-colors hover:text-primary-600 dark:hover:text-primary-400" href="/releases/">Releases</a><a class="transition-colors hover:text-primary-600 dark:hover:text-primary-400" href="https://github.com/ferforastieri/atacte" rel="noreferrer">GitHub</a></nav></div></footer>
  </div>
</template>
